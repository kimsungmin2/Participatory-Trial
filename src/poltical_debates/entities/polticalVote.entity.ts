...
export class PolticalDebateVotes {
    ...
    @OneToMany(() => EachPolticalVote, (eachPolticalVote) => eachPolticalVote.polticalDebateVotes, { cascade: true })
    eachPolticalVote: EachPolticalVote[];
        
    @OneToOne(() => PolticalDebateBoards, (polticalDebateBoards) => polticalDebateBoards.polticalDebateVotes)
