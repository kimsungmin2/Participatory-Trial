...
import { PolticalDabateHallOfFameService } from '../poltical_debates/politcal_debate_hall_of_fame.service';
import { PolticalDebateBoards } from '../poltical_debates/entities/poltical_debate.entity';
import { PolticalDebateVotes } from '../poltical_debates/entities/polticalVote.entity';
import { PolticalDebateHallOfFame } from '../poltical_debates/entities/poltical_hall_of_fame.entity';
import { PolticalDebateBoardsViewHallOfFames } from '../poltical_debates/entities/polticalView_hall_of_fame.entity';
...
describe('TrialHallOfFameService', () => {
  ...
  beforeEach(async () => {
    ...
    service = module.get<PolticalDabateHallOfFameService>(
      PolticalDabateHallOfFameService,
    );
    polticalRepository = module.get(getRepositoryToken(PolticalDebateBoards));
    polticalVotesRepository = module.get(
      getRepositoryToken(PolticalDebateVotes),
    );
    polticalDebateHOFRepository = module.get(
      getRepositoryToken(PolticalDebateHallOfFame),
    );
  ...
  describe('updateHallOfFame', () => {
    ...
    it('should handle errors gracefully', async () => {
      mockPolticalVoteRepository.find.mockRejectedValue(
  ...
  describe('getRecentHallOfFame', () => {
    it('should retrieve and paginate hall of fame entries correctly', async () => {
      ...
      mockPolticalDabateHallOfFamesRepository.find = jest
        .fn()
        .mockResolvedValue([]);
      mockPolticalDabateHallOfFamesRepository.count = jest
        .fn()
        .mockResolvedValue(0);
      ...
      expect(result).toEqual({ polticalDebateHallOfFame: [], totalItems: 0 });
    });
  });
  describe('getViewRecentHallOfFame', () => {
    it('should retrieve view hall of fame entries with correct pagination', async () => {
      ...
      mockPolticalDabateHallOfViewFamesRepository.find.mockResolvedValue(
        mockData,
      );
      ...
      expect(
        mockPolticalDabateHallOfViewFamesRepository.find,
  ...
  describe('aggVotesViewForHallOfFame', () => {
    it('should aggregate votes view for hall of fame correctly', async () => {
      ...
      expect(polticalRepository.createQueryBuilder).toBeCalledWith(
        'polticalDebateBoard',
      );
  ...
  describe('aggVotesVotesForHallOfFame', () => {
    it('should aggregate votes for hall of fame correctly', async () => {
      ...
      expect(polticalVotesRepository.createQueryBuilder).toBeCalledWith(
        'polticalDebateBoardVote',
      );
      ...
      expect(mockVoteQueryBuilder.groupBy).toHaveBeenCalledWith(
        'polticalDebateBoardVote.id',
      );
  ...
  describe('findOneBytrialHallofFameViews', () => {
    it('should return hall of fame entry when found', async () => {
      ...
      mockPolticalDabateHallOfViewFamesRepository.findOneBy.mockResolvedValue(
        mockEntry,
      );
      ...
      expect(
        mockPolticalDabateHallOfViewFamesRepository.findOneBy,
      ).toHaveBeenCalledWith({
        id: 1,
      });
  ...
  describe('findOneBytrialHallofFameVote', () => {
    it('should return hall of fame entry when found', async () => {
      ...
      mockPolticalDabateHallOfFamesRepository.findOneBy.mockResolvedValue(
        mockEntry,
      );
      ...
      expect(
        mockPolticalDabateHallOfFamesRepository.findOneBy,
      ).toHaveBeenCalledWith({
        id: 1,
      });
